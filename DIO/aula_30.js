...
const { gets, print } = require('./aula_30a.js');
...
const valorImposto = (calcularPorcentagem(valorBruto, imposto(valorBruto)))

const moneyFinished = valorBruto - valorImposto + beneficios

print(calcularPorcentagem(valorBruto, 10));
print(imposto(valorBruto));
print(moneyFinished);
